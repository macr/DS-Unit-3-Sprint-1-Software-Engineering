...
- What, in your opinion, is an important part of code reviews? That is, what is
  ...
  when others do the same for your code?
    - Trying to understand the context on what the code is trying to solve and articulating the problem with the proposed solution. Suggesting alternatives is also very helpful.
- We have an awful lot of computers here, and it gets pretty confusing with
  slightly different things running on all of them. How could containers help us
  improve this situation?
    - Containers creates an isolated environment that you can use for each project. This enables us to have a reproducible environment to run our code with. 
